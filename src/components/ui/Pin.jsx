...
export function PinContainer ({
  ...
  return (
    <Link
      className={cn(
        "group/pin relative z-50 flex flex-col justify-around w-full cursor-pointer",
        containerClassName,
      )}
    ...
    >
      <div
        ...
        className="absolute w-[500px] flex-row left-1/2 top-1/2 ml-[0.09375rem] mt-4"
      >
        <div
          style={{
            transform: transform,
          }}
          className="flex items-start w-full justify-start overflow-hidden rounded-3xl border border-white/[0.1] bg-black p-4 shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 group-hover/pin:border-white/[0.2]"
        >
      ...
      <div className="inset-0 -mt-7 h-full w-full flex-none">
        <div className="absolute inset-x-0 top-0 flex justify-center">
          <a
            href={href}
            target={"_blank"}
            className="relative z-10 flex flex-row items-center space-x-2 rounded-full bg-zinc-950 px-4 py-0.5 ring-1 ring-white/10"
          >
